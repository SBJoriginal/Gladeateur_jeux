    ...
    def dessiner_de(self, coordonnees, gauche, haut, droite, bas):
        ...
        if texte_de == "⚁":
            ...
            self.create_oval((gauche + (3 * l + 2 * d)), (haut + (1 * l + 0 * d)), (gauche + (3 * l + 3 * d)),
                             haut + (1 * l + 1 * d), fill='black')  # TR
            self.create_oval((gauche + (1 * l + 0 * d)), (haut + (3 * l + 2 * d)), (gauche + (1 * l + 1 * d)),
                             haut + (3 * l + 3 * d), fill='black')  # BL
            self.create_oval((gauche + (3 * l + 2 * d)), (haut + (3 * l + 2 * d)), (gauche + (3 * l + 3 * d)),
                             haut + (3 * l + 3 * d), fill='black')  # BR
            ...
            self.create_oval((gauche + (3 * l + 2 * d)), (haut + (1 * l + 0 * d)), (gauche + (3 * l + 3 * d)),
                             haut + (1 * l + 1 * d), fill='black')  # TR
            self.create_oval((gauche + (1 * l + 0 * d)), (haut + (2 * l + 1 * d)), (gauche + (1 * l + 1 * d)),
                             haut + (2 * l + 2 * d), fill='black')  # ML
            self.create_oval((gauche + (3 * l + 2 * d)), (haut + (2 * l + 1 * d)), (gauche + (3 * l + 3 * d)),
                             haut + (2 * l + 2 * d), fill='black')  # MR
            self.create_oval((gauche + (1 * l + 0 * d)), (haut + (3 * l + 2 * d)), (gauche + (1 * l + 1 * d)),
                             haut + (3 * l + 3 * d), fill='black')  # BL
            self.create_oval((gauche + (3 * l + 2 * d)), (haut + (3 * l + 2 * d)), (gauche + (3 * l + 3 * d)),
                             haut + (3 * l + 3 * d), fill='black')  # BR
